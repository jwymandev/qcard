...
/**
 * Debug version of AuthLoading component with extensive logging
 * to diagnose white screen issues
 */
export default function AuthLoading({ children }: { children: React.ReactNode }) {
  ...
  if (isLoading || status === 'loading') {
    // Check if we've been loading for more than 8 seconds (likely stuck)
